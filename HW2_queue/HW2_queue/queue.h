...
class queue  
{
  private:
  // Data members are:
  el_t el[MAX_SIZE]; // an array of string called el. 
  int  count;          // this variable will show how many element we have in the queue
  int  front;          //  will need to show the front element
  int  rear;           // will need to show the rear element

  public:    // prototypes to be used by the client
  // Note that no parameter variables are given

  //add exception handling classes here with comments
	  class Overflow {}; //thrown when queue overflow happens
	  class Underflow {}; // thrown when queue Underflow happens
